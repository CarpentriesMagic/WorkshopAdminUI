...
* [Email us your questions](mailto://hpc.researchcomputing@newcastle.ac.uk) at hpc.researchcomputing@newcastle.ac.uk
...
**[From the Newcastle RSE Team](https://rse.ncldata.dev/events)**
   * [Unix Shell](https://swcarpentry.github.io/shell-novice/instructor/aio.html)
   * [Git](https://swcarpentry.github.io/git-novice/aio.html)
   * and more (https://rse.ncldata.dev/events)
#### Online training from other institutions
* [HPC Carpentry](https://www.hpc-carpentry.org/index.html) and [The Carpentries](https://carpentries.org/lessons/)
* [ARCHER2](https://www.archer2.ac.uk/training/) in Edinburgh
* [ASC Vienna](https://events.asc.ac.at/category/4/) in Austria
